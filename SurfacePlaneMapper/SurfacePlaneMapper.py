...
class SurfacePlaneMapper(ScriptedLoadableModule):
  ...
  """
    ...
    def __init__(self, parent):
        ...
        self.parent.title = "SurfacePlaneMapper"  # TODO: make this more human readable by adding spaces
...
class SurfacePlaneMapperWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
  ...
  """
    ...
    """
        ...
        self.logic = SurfacePlaneMapperLogic()
...
class SurfacePlaneMapperLogic(ScriptedLoadableModuleLogic):
