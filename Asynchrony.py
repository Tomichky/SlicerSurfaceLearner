...
import sys
try:
    import qt  # Tentative d'importation de qt
except ImportError:
    try:
        import PyQt5 as qt  # Si qt échoue, essaie PyQt5
    except ImportError:
        try:
            import PySide2 as qt  # Si PyQt5 échoue, essaie PySide2
        except ImportError:
            print("Aucune des bibliothèques Qt (qt, PyQt5, PySide2) n'est installée.")
            raise
